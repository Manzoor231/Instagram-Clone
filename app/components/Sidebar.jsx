      ...
      <div className="sidebar w-[19.4%] sticky top-0 h-screen max-xl:w-20 bg-white border-r border-gray-300 max-xl:mr-24">
        <div className=" px-4 py-3 flex flex-col h-screen gap-4 ">
          <span className="py-6 px-3 group">
            ...
            <svg
              aria-label="Instagram"
              className="hidden max-xl:block max-xl:transition-all transition transform"
              fill="currentColor"
              height="24"
              role="img"
              viewBox="0 0 24 24"
          ...
          <ul className="flex flex-col gap-2 h-screen  text-sm ">
            ...
            <li className="cursor-pointer lists-item flex items-center gap-4  px-2 py-3 hover:bg-slate-100 hover:rounded-md transition-all">
              <svg
                aria-label="Reels"
                className="transition-all svg-icon"
                fill="currentColor"
                height="24"
                role="img"
                viewBox="0 0 24 24"
            ...
            <li className="cursor-pointer lists-item flex items-center gap-4  px-2 py-3 hover:bg-slate-100 hover:rounded-md transition-all">
              ...
              <svg
                ...
                className="svg-icon transition-all absolute "
                height="24"
                role="img"
                viewBox="0 0 24 24"
                width="24"
              >
                ...
                <path d="M17.79 10.132a.659.659 0 0 0-.962-.873l-2.556 2.05a.63.63 0 0 1-.758.002L11.06 9.47a1.576 1.576 0 0 0-2.277.42l-2.567 3.98a.659.659 0 0 0 .961.875l2.556-2.049a.63.63 0 0 1 .759-.002l2.452 1.84a1.576 1.576 0 0 0 2.278-.42Z" fill-rule="evenodd"></path>
                  ...
                  <span className=" left-[11px] -top-[7px] rounded-full px-[6px] py-[1px] text-white relative bg-red-500 text-xs">6</span>
                  </span>
          ...
          <div className=" flex  flex-col gap-3">
            <span className="lists-item flex items-center gap-3  px-2 py-3 hover:bg-slate-100 hover:rounded-md transition-all ">
              ...
              <span className="max-xl:hidden">Threads</span>
            </span>
            <button className="lists-item flex items-center gap-3   px-2 py-3 hover:bg-slate-100 hover:rounded-md transition-all mb-5 ">
              <svg
                aria-label="Settings"
                className="svg-icon transition-all"
                fill="currentColor"
